...
The J2 distribution bundle redistributes the following open-source components.
J2 itself is dual-licensed MIT OR Apache-2.0 (see LICENSE-MIT / LICENSE-APACHE).

## Toolchain

The bundled compiler backend, standard library, and build tool are derived from
the backend toolchain (https://github.com/backend-lang/backend), dual-licensed
MIT OR Apache-2.0, Copyright (c) The backend Project Contributors. The license
texts in LICENSE-MIT and LICENSE-APACHE apply to those components as well.

## Vendored library crates

The bundle ships the *source* of each crate below under `j2-vendor/`; every
...
| backend-cc-hash | 2.1.2 | Apache-2.0 OR MIT |
